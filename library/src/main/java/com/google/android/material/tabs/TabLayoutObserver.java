...
public final class TabLayoutObserver {
    ...
    @NonNull private final GridPageLayoutManager layoutManager;
    ...
    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPageLayoutManager mLayoutManager, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
        this(tabLayout, mLayoutManager, /* autoRefresh= */ true, tabConfigurationStrategy);
    }

    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPageLayoutManager mLayoutManager, boolean autoRefresh, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
        this(tabLayout, mLayoutManager, autoRefresh, /* smoothScroll= */ true, tabConfigurationStrategy);
    }

    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPageLayoutManager mLayoutManager, boolean autoRefresh, boolean smoothScroll, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
    ...
    public void attach() {
        ...
        layoutManager.registerOnQueueChangeListener(onPageChangeCallback);

        // Now we'll add a tab selected listener to set ViewPager's current item
        onTabSelectedListener = new ViewPagerOnTabSelectedListener(layoutManager, smoothScroll);
        ...
        tabLayout.setScrollPosition(layoutManager.getCurrentQueueItem(), 0f, true);
    }
    ...
    public void detach() {
        ...
        if (onPageChangeCallback != null) {
            layoutManager.unregisterOnQueueChangeListener(onPageChangeCallback);
    ...
    void populateTabsFromPagerAdapter() {
        ...
        if (layoutManager != null) {
            int adapterCount = layoutManager.getQueueSize();
